...
PATCHES=(
	...
	"${FILESDIR}/0001-Revert-to-5.14-winepulse.drv.patch"
	"${FILESDIR}/0002-5.14-Latency-Fix.patch"
	"${FILESDIR}/0003-secur32-Fix-crash-from-invalid-context-in-Initialize.patch"
	"${FILESDIR}/0004-kernelbase-Cache-last-used-locale-sortguid-mapping.patch"
	"${FILESDIR}/0005-Add-ps0034-and-ps0035-from-openglfreak.patch"
)
PATCHES_BIN=()
